...
<TypstPreview
  ...
  #smallcaps[Hello]
`}
  image='/typst-fumadocs/assets/d860d23f8025b71987581bf155766bc1.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #lorem(40)
`}
  image='/typst-fumadocs/assets/7f47b81d5cd6ecd285a78baa93a2efaa.png'
  alt='Preview'
  editable={true}
/>
...
<TypeTable
  type={{
    'all': {
      'description': 'Whether to turn uppercase letters into small capitals as well.  Unless overridden by a show rule, this enables the `c2sc{:typst}` OpenType feature.  <TypstPreview   code={`   #smallcaps(all: true)[UNICEF] is an   agency of #smallcaps(all: true)[UN]. `}   image=\'/typst-fumadocs/assets/f26ae448d07a9e76c623cf95561882ad\'   alt=\'Preview\'   editable={true} />',
      'type': 'bool',
