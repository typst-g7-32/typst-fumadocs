...
<TypeTable
  type={{
    'all': {
      'description': 'Whether to turn uppercase letters into small capitals as well.  Unless overridden by a show rule, this enables the `c2sc{:typst}` OpenType feature.  <TypstPreview   code={`   #smallcaps(all: true)[UNICEF] is an   agency of #smallcaps(all: true)[UN]. `}   image=\'/assets/f26ae448d07a9e76c623cf95561882ad.png\'   alt=\'Preview\'   editable={true} />',
      'type': 'bool',
