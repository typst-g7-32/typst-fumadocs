...
<TypstPreview
  ...
  #(("A", "B", "C")
      .join(", ", last: " and "))
`}
  image='/typst-fumadocs/assets/b82dcffb69c678f6966654cb6a9894a3.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #array(bytes(hi))
`}
  image='/typst-fumadocs/assets/5f88747ad7a056745bb4d94b9e4440e4.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #range(5, 2, step: -1)
`}
  image='/typst-fumadocs/assets/ceb87963d025cafe69d4f502bb2cf46c.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/4bbc8a9ddf0acf4358de76c1f38313a8.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/74abb75036c3e00c4b810d4e0d74f915.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/e0d10d9d30f4e678ab9479679fad56ab.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #("A", "B", "C").intersperse("-")
`}
  image='/typst-fumadocs/assets/9ad27cdd1677fc26080cad0c262e0c93.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/35c1baf0f7902b3b48cc164333d55b.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #array.windows(5)
`}
  image='/typst-fumadocs/assets/19a732fa351d05f71c5f8ddfc73c2a3e.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/fe903cbcc2093647a0fabae43aaaaf52.png'
  alt='Preview'
  editable={true}
/>
...
<TypstPreview
  ...
  #(3, 3, 1, 2, 3).dedup()
`}
  image='/typst-fumadocs/assets/eb5537b1ca487f754e0c896313f339ba.png'
  alt='Preview'
  editable={true}
/>
...
<TypeTable
  type={{
    'key': {
      'description': 'If given, applies this function to each element in the array to determine the keys to deduplicate by.  <TypstPreview   code={`   #("apple", "banana", " apple ").dedup(key: s => s.trim()) `}   image=\'/typst-fumadocs/assets/f407445b261ebb675e8a26021d5f339\'   alt=\'Preview\'   editable={true} />',
      'type': 'function',
      'default': 'None'
    }
  }}
...
`}
  image='/typst-fumadocs/assets/2e6b8e445cf77edd022ddf968946479e.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/1e6640799dfe1da6d9f5eea2ffbf5c92.png'
  alt='Preview'
  editable={true}
/>
