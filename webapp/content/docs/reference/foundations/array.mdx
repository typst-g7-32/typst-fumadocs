...
<TypeTable
  type={{
    'key': {
      'description': 'If given, applies this function to each element in the array to determine the keys to deduplicate by.  <TypstPreview   code={`   #("apple", "banana", " apple ").dedup(key: s => s.trim()) `}   image=\'/assets/f407445b261ebb675e8a26021d5f339.png\'   alt=\'Preview\'   editable={true} />',
      'type': 'function',
      'default': 'None'
    }
  }}
