...
<TypeTable
  type={{
    ...
    'baseline': {
      'description': 'An amount to shift the box\'s baseline by.  <TypstPreview   code={` Image: #box(baseline: 40%, image("tiger.jpg", width: 2cm)). `}   image=\'/assets/8cd6665dc2d94162a88dbe58873dee11.png\'   alt=\'Preview\' />',
      'type': 'relative',
