...
<TypeTable
  type={{
    ...
    'mirror': {
      'description': 'Whether to mirror the gradient at every second repetition, i.e., the first instance (and all odd ones) stays unchanged.  <TypstPreview   code={` #circle(   radius: 40pt,   fill: gradient     .conic(green, black)     .repeat(2, mirror: true) ) `}   image=\'/assets/12eb6ef0f82817124abc5d9167ff35dc.png\'   alt=\'Preview\' />',
      'type': 'bool',
