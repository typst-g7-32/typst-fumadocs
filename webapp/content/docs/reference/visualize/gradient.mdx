...
`}
  image='/typst-fumadocs/assets/ff29eecb918a915ec00ed5fcec2f4488.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/721d0b00b502c2e4285439f1ac4fd467.png'
  alt='Preview'
  editable={true}
/>
...
<img src="/typst-fumadocs/assets/be18b60088f1dd3f2eaeacbfe340c3b1" alt="Preview" />
</div>
...
`}
  image='/typst-fumadocs/assets/71783179a4cfd9c8bb34bd7a6b7ac1fe.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/def0956800e63dc52a60e2e66b8fb072.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/21f904edb21c2e1ac7db89749e4d2c21.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/32a99c7b0b1cb9e924d91b259fba0aca.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/93522b26f5475bd0d38d77f01dd7e1fd.png'
  alt='Preview'
  editable={true}
/>
...
`}
  image='/typst-fumadocs/assets/c9d6c600cc20c2f18c089a5f32cd7000.png'
  alt='Preview'
  editable={true}
/>
...
<TypeTable
  type={{
    ...
    'mirror': {
      'description': 'Whether to mirror the gradient at every second repetition, i.e., the first instance (and all odd ones) stays unchanged.  <TypstPreview   code={`   #circle(     radius: 40pt,     fill: gradient       .conic(green, black)       .repeat(2, mirror: true)   ) `}   image=\'/typst-fumadocs/assets/12eb6ef0f82817124abc5d9167ff35dc\'   alt=\'Preview\'   editable={true} />',
      'type': 'bool',
