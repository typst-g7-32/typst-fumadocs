...
<TypeTable
  type={{
    ...
    'fill-rule': {
      'description': 'The drawing rule used to fill the curve.  <TypstPreview   code={` // We use \\`.with\\` to get a new // function that has the common // arguments pre-applied. #let star = curve.with(   fill: red,   curve.move((25pt, 0pt)),   curve.line((10pt, 50pt)),   curve.line((50pt, 20pt)),   curve.line((0pt, 20pt)),   curve.line((40pt, 50pt)),   curve.close(), )  #star(fill-rule: "non-zero") #star(fill-rule: "even-odd") `}   image=\'/assets/32d08694d1725fb4fc044b295913753b.png\'   alt=\'Preview\' />',
      'type': 'str',
      'default': '<code><span class="typ-str">&quot;non-zero&quot;</span></code>'
    },
    'stroke': {
      'description': 'How to [stroke](/docs/reference/visualize/stroke/) the curve.  Can be set to `none{:typst}` to disable the stroke or to `auto{:typst}` for a stroke of `1pt{:typst}` black if and only if no fill is given.  <TypstPreview   code={` #let down = curve.line((40pt, 40pt), relative: true) #let up = curve.line((40pt, -40pt), relative: true)  #curve(   stroke: 4pt + gradient.linear(red, blue),   down, up, down, up, down, ) `}   image=\'/assets/6e6243695ed1c92082c2dfde5dadc46.png\'   alt=\'Preview\' />',
