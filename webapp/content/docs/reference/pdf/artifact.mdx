---
title: "Artifact"
description: "Documentation for the `artifact` function."
---
...
In the future, this function may be moved out of the `pdf{:typst}` module, making it possible to hide content in HTML export from AT.

```#pdf.artifact(kind:, body) -> content```
...
<TypeTable
  type={{
    'kind': {
      ...
      'type': 'str',
      'default': '<code><span class="typ-str">&quot;other&quot;</span></code>'
    },
    'body': {
