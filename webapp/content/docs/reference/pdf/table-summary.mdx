---
title: "Table Summary"
description: "Documentation for the `table-summary` function."
---
...
The API of this feature is temporary. Hence, calling this function requires enabling the `a11y-extras{:typst}` feature flag at the moment. Even if this functionality should be available without a feature flag in the future, the summary will remain exclusive to PDF export.
...
`}
  image='/typst-fumadocs/assets/c201ac9a658ef04d467227539fa50795.png'
  alt='Preview'
  editable={true}
/>
