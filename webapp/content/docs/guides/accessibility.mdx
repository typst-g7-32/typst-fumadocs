...
`}
  image='/assets/1b3385d4711d911b023f85c4b77c69d8.png'
  alt='Preview'
/>
...
= Heading
`}
  image='/assets/cea9024d2a17cd0d7d7ffffffc6673eb.png'
  alt='Preview'
/>
...
`}
  image='/assets/a870bd2924e6c08865ca0ef3b0046e7c.png'
  alt='Preview'
/>
...
<div>
 <img src="/assets/chart-good.png" alt="The same bar chart with the original colors. This time, black outlines around each segment are added. Additionally, each segment has a unique pattern." style={{boxShadow: '0 4px 12px rgb(89 85 101 / 20%)', width: '500px', maxWidth: '100%', height: 'auto', display: 'block', margin: '24px auto', borderRadius: '6px'}} width="958" height="637" /> 
</div>
...
up to 2.3 m.
`}
  image='/assets/c19e066f538edb97ce57f630f6cb56a8.png'
  alt='Preview'
/>
...
`}
  image='/assets/e96165d4834d11194fdaf6bee05bd86b.png'
  alt='Preview'
/>
